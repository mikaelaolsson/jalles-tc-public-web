...
paginationForm === null || paginationForm === void 0 ? void 0 : paginationForm.addEventListener('submit', function () {
    currentPage.value = '1';
});
...
function submitPaginationForm() {
    ...
    if ((selectedInput === null || selectedInput === void 0 ? void 0 : selectedInput.value) !== undefined || null || 'Alla') {
        selectedInput.value = selectedCategory.value;
    }
    paginationForm === null || paginationForm === void 0 ? void 0 : paginationForm.submit();
}
