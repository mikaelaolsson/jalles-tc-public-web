...
public class StartPageController : RenderControllerBase
{
    ...
    public StartPageController(ICompositeViewEngine compositeViewEngine, 
    ...
    public async Task<IActionResult> IndexAsync()
    {
        ...
        var model = await LayoutViewModel<StartPageViewModel>.CreateAsync(viewModel, CurrentPage!, HttpContext);
